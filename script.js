...
// objects
const map = addLevel([
    "tttttttttttttttttttttttttttttttttttp ttttttttttttt",
    "cwwwwwwwwwwwwwwwwdwwwwwwwwwwwwwwwww  wwwwwwwwwwwwd",
    "l                r                               r",
    "l                                                r",
    "l                r                               r",
    "l                r                               r",
    "l                r                               r",
    "l                r                               r",
    "attttttt    tttttbttttttttttttttt  ttttttttttttttb",
    "cwwwwwww    wwwwwdwwwwwwwwwwwwwww  wwwwwwwwwwwwwwd",
    "l                r                               r",
    "l             $  r                               r",
    "l                r                               r",
    "l                r                               r",
    ...
    "l                                                r",
    "l                                                r",
    "attttttttttttttttttttttttttttttttttttttttttttttttb",
